...
from lstm import BiLSTMAttention_TTA,BiLSTMAttention_TTA_plus
from topk import topK_loss
...
# model = BiLSTMAttention_TTA(input_size, hidden_size, num_classes)
model = BiLSTMAttention_TTA_plus(input_size, hidden_size, num_classes)
